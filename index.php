...
<body>
   ...
   <div class="container">
      ...
      <a href="add.php" class="btn btn-dark-center">Ajouter</a>
      <a href="details.php" class= 'btn btn-dark-center' <i class='btn btn-info btn-sm fs-5'></i>
                        Détails
                       </a>
      <a href="receptionnes.php" class="btn btn-dark-center">Voir les immeubles réceptionnés</a>
                 
      <table id="immeublesTable" class="table table-bordered table-striped ">
            ...
            if (mysqli_num_rows($result) > 0) {
               while ($row = mysqli_fetch_assoc($result)) {
                  echo "<tr>
                           ...
                           <td>
                          <div class='d-flex'>
                          <a href='edit.php?id={$row['Id']}' class='link-dark me-3'>
                        <i class='fa-solid fa-pen-to-square fs-5'></i>
                        </a>
                        <a href='delete.php?id={$row['Id']}' class='link-dark me-3'>
